<template>
  <div class="demo full">
    ...
    <nut-swipe>
      ...
      <template #right>
        <nut-button shape="edge" style="height: 100%" type="danger">{{ translate('delete') }}</nut-button>
      </template>
    </nut-swipe>
    ...
    <nut-swipe>
      <template #left>
        <nut-button shape="edge" style="height: 100%" type="success">{{ translate('select') }}</nut-button>
      </template>
      <nut-cell round-radius="0" :desc="translate('swipeLRDesc')" />
      <template #right>
        <nut-button shape="edge" style="height: 100%" type="danger">{{ translate('delete') }}</nut-button>
        <nut-button shape="edge" style="height: 100%" type="info">{{ translate('collect') }}</nut-button>
      </template>
    </nut-swipe>

...
|----- | ----- | ----- 
|start `v0.1.0` | signature start callback function (refers to the beginning of a stroke) | none
|signing `v0.1.0`| the callback function being signed (refers to a stroke in progress) | event
|end `v0.1.0`| signature end callback function (refers to the end of a stroke) | none

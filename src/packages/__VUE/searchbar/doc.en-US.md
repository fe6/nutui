...
|label `v0.1.0`| left text of search box | string | ''|
...
|autofocus `v0.1.0` | Auto focus | boolean | false |
|disabled `v0.1.0`| disable input box | Boolean | false|
|readonly `v0.1.0`| input box read only | Boolean | false|
|input-align `v0.1.0`| alignment, optional ` center ` ` right ` | string | left |
...
| click-input `v0.1.0`| Triggered when the input field is clicked| event |
| click-left-icon `v0.1.0`| Triggered when the icon on the left is clicked| val, event |
| click-right-icon `v0.1.0`| Triggered when the icon on the right is clicked| val, event |

...
| close-on-click-overlay `v0.1.0` | 是否在点击遮罩层后关闭菜单     | Boolean                 | true    |
| scroll-fixed `v0.1.0`           | 滚动后是否固定，可设置固定位置 | Boolean、String、Number | false   |
| title-class `v0.1.0`            | 自定义标题样式类               | String                  | -       |
| lock-scroll `v0.1.0`            | 背景是否锁定                   | Boolean                 | true    |
...
| option-icon `v0.1.0`         | 自定义选项图标                          | String  | 'Check'          |
| direction  `v0.1.0`          | 菜单展开方向，可选值为up                | String  | 'down'           |
| active-title-class `v0.1.0`   | 选项选中时自定义标题样式类              | String  | -                |
| inactive-title-class `v0.1.0` | 选项非选中时自定义标题样式类            | String  | -                |

...
| title `v0.1.0` | 标题 | String   | ''      |
| close-icon-position `v0.1.0` | 取消按钮位置，继承 Popup 组件 | String   | "top-right"      |
| close-icon `v0.1.0` | 自定义关闭按钮，继承 Popup 组件 | String   | "close"     |
| closeable `v0.1.0` | 是否显示关闭按钮，继承 Popup 组件 | Boolean   | true     |

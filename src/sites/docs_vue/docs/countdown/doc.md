...
| format `v0.1.0` |  时间格式 | String | HH:mm:ss
| millisecond `v0.1.0` |  是否开启毫秒级渲染 | Boolean | false
| auto-start `v0.1.0` |  是否自动开始倒计时 | Boolean | true
| time `v0.1.0` | 倒计时显示时间，单位是毫秒。autoStart 为 false 时生效 | String，Number | 0
| paused | 是否暂停 | Boolean | false
| show-days | 是否显示天`v0.1.0(废弃)` | Boolean | false
| show-plain-text | 显示为纯文本`v0.1.0(废弃)` | Boolean | false

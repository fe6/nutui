...
| title `v0.1.0`     | Title                                                                                                        | String   | ''          |
| close-icon-position `v0.1.0` | Cancel the button position and inherit the popup component                                                   | String   | "top-right" |
| close-icon `v0.1.0` | Customize the close button and inherit the popup component                                                   | String   | "close"     |
| closeable `v0.1.0` | Whether to display the close button and inherit the popup component                                          | Boolean  | true        |

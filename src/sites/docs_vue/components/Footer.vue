  ...
  <div class="doc-footer" :class="`doc-footer-${themeColor}`">
    <div class="doc-footer-content" :class="!showLogo ? 'minisize' : ''">
      <div class="doc-footer-list" v-if="showLogo">
        <img class="doc-footer-logo" v-if="isJDT()" src="@/sites/docs_vue/assets/images/logo-blue-jdt-footer.png" />
        <img
          class="doc-footer-logo"
          v-else-if="language.toLowerCase() == 'vue'"
          src="@/sites/docs_vue/assets/images/logo-header-red.png"
        />
        <img class="doc-footer-logo" v-else src="@/sites/docs_vue/assets/images/logo-header-red-react.png" />
      </div>
...
import { repository, language } from '@/sites/docs_vue/config/index';
...
.icon-vx {
  ...
  margin-left: 5px;
  vertical-align: -2px;
  background: url('@/sites/docs_vue/assets/images/icon-footer-vx.png') no-repeat center/100%;
}
.vx-box {
  display: none;
  position: absolute;

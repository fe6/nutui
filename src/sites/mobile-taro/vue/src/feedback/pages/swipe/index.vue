<template>
  <div class="demo full">
    ...
    <nut-swipe>
      ...
      <template #right>
        <nut-button shape="edge" style="height: 100%" type="danger">删除</nut-button>
      </template>
    </nut-swipe>
    <h2>禁止滑动</h2>
    <nut-swipe disabled>
    ...
    <nut-swipe>
      <template #left>
        <nut-button shape="edge" style="height: 100%" type="success">选择</nut-button>
      </template>
      <nut-cell round-radius="0" desc="左滑右滑都可以哦" />
      <template #right>
        <nut-button shape="edge" style="height: 100%" type="danger">删除</nut-button>
        <nut-button shape="edge" style="height: 100%" type="info">收藏</nut-button>
      </template>
    </nut-swipe>
    <h2>异步控制</h2>
